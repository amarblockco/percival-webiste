...
/* template.twig */
class __TwigTemplate_39880cee14287b95471b56efa21cf21bdb74d7aff1a738bc530a40572cc7f09b extends \WPML\Core\Twig\Template
{
    ...
    {
        // line 1
        $context["current_language"] = $this->getAttribute((isset($context["languages"]) ? $context["languages"] : null), (isset($context["current_language_code"]) ? $context["current_language_code"] : null), [], "array");
        // line 2
...
\t\t<li tabindex=\"0\" class=\"";
        // line 11
        echo \WPML\Core\twig_escape_filter($this->env, $this->getAttribute((isset($context["current_language"]) ? $context["current_language"] : null), "css_classes", []), "html", null, true);
        echo " wpml-ls-item-legacy-dropdown\">
\t\t\t<a href=\"#\" class=\"";
        // line 12
        echo \WPML\Core\twig_escape_filter($this->env, \WPML\Core\twig_trim_filter(("js-wpml-ls-item-toggle wpml-ls-item-toggle " . $this->getAttribute($this->getAttribute((isset($context["current_language"]) ? $context["current_language"] : null), "backward_compatibility", []), "css_classes_a", []))), "html", null, true);
        echo "\">";
        // line 13
        if ($this->getAttribute((isset($context["current_language"]) ? $context["current_language"] : null), "flag_url", [])) {
            // line 14
            echo "<img class=\"";
            echo \WPML\Core\twig_escape_filter($this->env, (isset($context["css_classes_flag"]) ? $context["css_classes_flag"] : null), "html", null, true);
            echo "\" src=\"";
            echo \WPML\Core\twig_escape_filter($this->env, $this->getAttribute((isset($context["current_language"]) ? $context["current_language"] : null), "flag_url", []), "html", null, true);
            echo "\" alt=\"";
            echo \WPML\Core\twig_escape_filter($this->env, $this->getAttribute((isset($context["current_language"]) ? $context["current_language"] : null), "flag_alt", []), "html", null, true);
            echo "\">";
        }
        // line 17
        if (($this->getAttribute((isset($context["current_language"]) ? $context["current_language"] : null), "display_name", []) || $this->getAttribute((isset($context["current_language"]) ? $context["current_language"] : null), "native_name", []))) {
            // line 18
            $context["current_language_name"] = (($this->getAttribute((isset($context["current_language"]) ? $context["current_language"] : null), "display_name", [], "any", true, true)) ? (\WPML\Core\_twig_default_filter($this->getAttribute((isset($context["current_language"]) ? $context["current_language"] : null), "display_name", []), $this->getAttribute((isset($context["current_language"]) ? $context["current_language"] : null), "native_name", []))) : ($this->getAttribute((isset($context["current_language"]) ? $context["current_language"] : null), "native_name", [])));
            // line 19
            echo "<span class=\"";
...
";
    ...
    {
        return new Source("", "template.twig", "/home/percivaltoken/public_html/wp-content/plugins/sitepress-multilingual-cms/templates/language-switchers/legacy-dropdown/template.twig");
    }
}
